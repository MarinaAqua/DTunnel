...
function getวเลสConfig(userIDs, hostName) {
	const commonUrlPart = `:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=/gratis#VLESS TLS`;
	const commonUrlPart1 = `:80?encryption=none&security=none&fp=randomized&type=ws&host=${hostName}&path=/gratis#VLESS NTLS`;
	const hashSeparator = "▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬";
...
<a href='https://vless.clubgratis.xyz' target='_blank'><i class="fa fa-home" style="font-size:25px;color:blue"></i></i>Back Menu</a></p>`;
